        ...
        <nav className="topbar">
          <div className="section-inner flex items-center justify-between h-16 px-6">
            <a href="/" className="flex items-center gap-2 group">
              ...
              <span className="text-lg font-extrabold text-[var(--text)]">WildTrace</span>
            </a>
            <div className="flex items-center gap-2">
              {[
                ...
                <a key={l.href} href={l.href}
                   className="px-3 py-1.5 text-sm font-bold text-[var(--text-secondary)] hover:text-[var(--text)] transition-colors rounded-xl hover:bg-[var(--bg-alt)]">
                  {l.label}
                </a>
              ))}
              <a href="/sightings/new" className="btn btn-green btn-sm ml-2">
                📸 Report
              </a>
            </div>
          </div>
