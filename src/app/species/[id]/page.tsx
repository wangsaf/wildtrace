...
// ChatGPT-generated sprite sheets (high quality, per-animation)
const SPRITE_PATHS: Record<string, string> = {
  'Sumatran Tiger': '/pixel/tiger',
};

function getSpriteBasePath(name: string): string | null {
  return SPRITE_PATHS[name] || null;
}
...
export default function SpeciesDetailPage() {
  ...
  const spriteBasePath = getSpriteBasePath(species.name);
